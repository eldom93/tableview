...
// When the user clicks anywhere outside of the modal, close it
    ...
    $(document).ready(function () {
       ...
       /* $('#saveview').on('click', function (e) {
        ...
        var tble = document.getElementById('action-btn');
        var selectwrapper = document.createElement('div');
        var select = document.createElement('select');
        select.className = 'dropdown';
       // select.id = 'openModalBtn';
        ...
        tble.appendChild(selectwrapper);
        $( ".dropdown" ).change(function() {
            ...
            if(option1.selected === true){
                ...
                console.log('view props not selected');
            }
        });
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            console.log( table.row( this ).data() );
            var modalData = document.getElementsByClassName("details");
            for(var i = 0; i < modalData.length;i++){
                modalData[i].value = table.row( this ).data()[i+1]; 
            }
        } );
       ...
       /* $('dropdown').on('change', function (e) {
        ...
        function addCookie(){
            var tableSearch = document.getElementById('inlineFormInputGroup').value;
            if(tableSearch != ""){
                name = tableSearch;
                ...
                console.log('table search empty');
            }
